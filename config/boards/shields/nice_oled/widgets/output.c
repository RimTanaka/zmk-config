...
static void draw_usb_connected(lv_obj_t *canvas) {
  ...
  lv_canvas_draw_img(canvas, 5, 53, &usb, &img_dsc);
...
static void draw_ble_unbonded(lv_obj_t *canvas) {
  ...
  // 36 - 39
  lv_canvas_draw_img(canvas, 4, 49, &bt_unbonded, &img_dsc);
...
static void draw_ble_disconnected(lv_obj_t *canvas) {
  ...
  lv_canvas_draw_img(canvas, 9, 49, &bt_no_signal, &img_dsc);
...
static void draw_ble_connected(lv_obj_t *canvas) {
  ...
  lv_canvas_draw_img(canvas, 9, 49, &bt, &img_dsc);
